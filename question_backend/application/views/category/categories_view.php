            ...
            <tbody>
                <?php 
                    foreach($categories as $category){
                        ...
                        echo "<a href='" . base_url() . "Category/deleteCategoryDo/" . $category->category_id . "' class='btn btn-danger btn-sm' onclick='confirm(\"คุณต้องการ ลบ?\")'><i class='fas fa-trash'></i>Delete</a> </td>";
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
