    ...
    <div class="row">
      <div class="col-md-12">
      	...
      	if(!empty($page) && $page=="home"){?>
      		<div class='card card-primary highhome'><?php
      	}else{?>
           	...
           	<div class="card-body">
			        ...
			        ?>
      	 			<div id="wrapper">
				        ...
				        <label for="publish_status" class="col-5 col-sm-5 col-form-label text-al-r"></label>
        	 		...
        	 		<div class="col-sm-12">
				            ...
				            <label for="publish_name" class="col-5 col-sm-5 col-form-label text-al-r"></label>
				            <div class="col-7 col-sm-7">
        ...
        <?php if(!empty($SEV->person_prefix) && !empty($TB->Fname) && !empty($TB->Lname)){?>
            ...
            ?>
            <!-- <img src='<?php echo $img1; ?>' height="23px;">
            <img src='<?php echo $img2; ?>' height="23px;">
            <img src='<?php echo $img3; ?>' height="23px;"> -->
          </div>
