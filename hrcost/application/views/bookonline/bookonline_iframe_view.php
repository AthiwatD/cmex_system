...
<div class="card">
    <div class="card-header" style="text-align: right;">
        <?php if($system=="backend"){ ?>
            <a href="<?php echo base_url(); ?>Recruit/addRecruit"><button type="button" class="btn btn-success"><i class="nav-icon fas fa-plus"></i> เพิ่มหนังสือเวียนออนไลน์</button></a>
        <?php } ?>
    </div>
    <div class="card-body">
        <table class="table table-bordered table-striped my_table_data_desc" style="width:99% !important;">
            <thead>
                <tr>
                    <!-- <th>ลำดับ</th> --> <!-- [ton][13/05/2564][edit front view for iframe] -->
                    <?php if($system=="frontend"){ ?> <th style="min-width: 100px;">วันที่ประกาศ</th> <?php }?>
                    <?php if($system=="backend"){ ?> <th style="min-width: 100px;">วันที่ประกาศ</th> <?php }?>
                    <th style="min-width: 90px;">วันที่สิ้นสุด</th>
                    <!-- <th style="min-width: 85px;">ประเภท</th> -->
                    <th style="min-width: 75px;">ตำแหน่ง</th>
                    <th>หน่วยงาน</th>
                    ...
                    <th style="min-width: 40px;">เอกสาร</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    foreach($recruits as $recruit){
                        ...
                        if($system=="frontend"){  //[Frontend] //[ton][delete date("Y-m-d H:i:s")<$recruit->end_date && ]
                            echo "<tr>";
                                // echo "<td style='text-align:center;'>" .$count_page. "</td>"; // [ton][13/05/2564][edit front view for iframe]
                                ...
                                if($system=="frontend"){
                                    if($seconds_create_date <=604800){ 
                                        ...
                                        <div> <?php
                                            ...
                                            if($seconds_create_date <=604800){ $path_img=base_url()."assets/img/news.gif"; ?>&nbsp; <img src="<?php echo $path_img; ?>" style="margin:-3px 0px 0px 3px;"width="22%">
                                            <?php } ?>
                                        </div>
                                    </td> <?php
                                }
