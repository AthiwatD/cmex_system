...
// [ton][10/06/2564][add host_url]
// define('HOST_URL','http://excellent.med.cmu.ac.th/');
define('HOST_URL','http://localhost:8888/');

//[Athiwat][15/06/2564][add sitekey && secretkey (reCAPTCHA)]
// define('SITE_KEY','6LctKTAbAAAAACNk_WBnQsKXsfEzuz1mFmjA-H7f');    	//[on web server]
// define('SECRET_KEY','6LctKTAbAAAAAGm6OOS2G56T9I3-jwzmPch6wnxB'); 	//[on web server]
define('SITE_KEY','6LdwbTAbAAAAANJf1KbC8weYM9p955mQfZvSGhfC');      	//[on web localhost]
define('SECRET_KEY','6LdwbTAbAAAAAATQLppQI8VoAjraQoucZFIZfo0C'); 		//[on web localhost]
