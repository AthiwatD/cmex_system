            ...
            <tbody>
                <?php 
                    foreach($meetings as $meeting){
                        ...
                        echo "<a href='" . base_url() . "Meeting/meetingPdf/" . $meeting->meeting_id . "' class='btn btn-info btn-sm' target='_blank'><i class='fas fa-folder'></i>PDF</a> ";
                        ...
                        echo "<a href='" . base_url() . "Meeting/deleteMeetingDo/" . $meeting->meeting_id . "' class='btn btn-danger btn-sm' onclick='return confirm(\"คุณต้องการ ลบ?\")'><i class='fas fa-trash'></i>Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
