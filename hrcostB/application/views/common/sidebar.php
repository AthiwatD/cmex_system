...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- [Athiwat][25/06/2564][add bko_url] -->
    <?php if($system=="fronted") $sys="front"; else $sys="back";?>
    <?php $bko_url=base_url().IS_PATHINDEX.$sys; ?>

    <a href="<?php echo $bko_url; ?>" class="brand-link">
      <!-- [Athiwat][14/07/2564][add new img logo organization] -->
      <!-- <img src="<?php echo base_url(); ?>../common/assets/images/logo_cmex.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
      <img src="<?php echo base_url(); ?>../common/assets/images/logo_cmex.png" alt="AdminLTE Logo" class="brand-image" style="">
      <span class="brand-text font-weight-light" style="padding-left 10px !important; font-size: 16px;"><?php echo IS_PJNAME; ?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image" style="padding-left: 0px;">
          <?php // [Athiwat][02/07/2564][add file_exists()]
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo $bko_url; ?>" class="nav-link">
            <i class="nav-icon fas fa-sticky-note"></i>
              <p><?php echo IS_PJNAME_DT; ?></p>
            </a>
          </li>

          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>Shcmenu/index/back" class="nav-link">
            <i class="nav-icon fas fa-th-large"></i>
              <p><?php echo IS_SHCMENU; ?></p>
            </a>
          </li>
