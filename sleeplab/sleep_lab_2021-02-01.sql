...
--
-- Table structure for table `sdc_booking`
--

CREATE TABLE `sdc_booking` (
  `booking_id` int(11) NOT NULL,
  `patient_id` int(11) NOT NULL,
  `receiving_date` date DEFAULT NULL,
  `booking_date` date DEFAULT NULL,
  `doctor` varchar(100) DEFAULT NULL,
  `operation_room` varchar(20) DEFAULT NULL,
  `test_type` varchar(50) DEFAULT NULL,
  `appointment_from` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `sdc_booking`
--

INSERT INTO `sdc_booking` (`booking_id`, `patient_id`, `receiving_date`, `booking_date`, `doctor`, `operation_room`, `test_type`, `appointment_from`, `channel`, `changed`, `change_reason`, `status`, `note`, `create_by`, `create_time`, `update_by`, `update_time`, `deleted`) VALUES
(1, 1, '2021-02-01', '2021-02-08', '', '623', NULL, '', '', 0, NULL, NULL, '', '61018', '2021-02-01 10:51:02', '61018', '2021-02-01 03:31:37', 0),
(4, 4, '2021-02-01', '2021-02-09', '', '622', '', '', '', 0, NULL, NULL, '', '61018', '2021-02-01 11:49:00', '61018', '2021-02-01 03:47:21', 0),
(24, 11, '2021-02-01', '2021-02-08', '', '621', NULL, '', '', 0, NULL, NULL, '', '61018', '2021-02-01 02:09:21', '61018', '2021-02-01 03:31:37', 0),
(25, 12, '2021-02-01', '2021-02-08', '', '622', '', '', '', 0, NULL, NULL, '', '61018', '2021-02-01 02:28:34', '61018', '2021-02-01 03:47:51', 0);

-- --------------------------------------------------------

--
-- Table structure for table `sdc_patient`
--

CREATE TABLE `sdc_patient` (
  `patient_id` int(11) NOT NULL,
...
--
-- Dumping data for table `sdc_patient`
--

INSERT INTO `sdc_patient` (`patient_id`, `fname`, `lname`, `hn`, `birth_date`, `tel_1`, `tel_2`, `create_by`, `create_time`, `update_by`, `update_time`, `deleted`) VALUES
(1, 'อธิป', 'น้อมศิริ', '1377380', '1986-06-06', '0814725891', '', '61018', '2021-02-01 10:51:02', '61018', '2021-02-01 01:41:25', NULL),
(4, 'ddd', 'ddd', '123456', '2021-01-31', '123456789', '', '61018', '2021-02-01 11:49:00', '61018', '2021-02-01 03:47:21', NULL),
(11, 'ทดสอบ', 'ทดสอบ', '1472589', '2021-01-31', '147258963', '', '61018', '2021-02-01 02:09:21', NULL, NULL, NULL),
(12, 'eeeee', 'eeee', '12345', '2021-01-31', '123456789', '', '61018', '2021-02-01 02:28:34', '61018', '2021-02-01 03:47:51', NULL);
...
(11, 'ศูนย์การแพทย์เพื่อการมีบุตร', 'CFC');
...
('55007', 'นางสาว', 'สุจิตรา', 'เตชะเต่ย', '3580100102930', '2011-11-01', 20, 6, 1, '2019-09-30'),
...
('58003', 'นาย', 'ณพรรษกรณ์', 'คงภาษี', '1509901152325', '2015-01-15', 2, 6, 0, '0000-00-00'),
...
('58046', 'นางสาว', 'ปณาลี', 'อุประดิษฐ์', '1509901256597', '2015-09-01', 5, 10, 1, '2020-10-16'),
('58047', 'นางสาว', 'อุบลวรรณ', 'ภู่สว่าง', '1570700175109', '2015-09-01', 5, 10, 1, '2020-10-16'),
...
('59033', 'นาย', 'ชัยธวัช', 'กิตติคุณากร', '1509901363437', '2015-12-01', 18, 1, 1, '2020-11-01'),
...
('61004', 'นางสาว', 'จันทิรา', 'ภูมาศ', '1549900057876', '2017-11-01', 26, 1, 1, '2020-11-01'),
...
('61037', 'นางสาว', 'ประภาวรินทร์', 'ภูวเดชโภคนิษฐ์', '1509900540925', '2018-06-01', 33, 3, 1, '2020-11-01'),
...
('62018', 'นางสาว', 'ณฐพร ', 'เจิดจำรัส', '1509900463181', '2019-04-01', 8, 1, 0, '2019-05-14'),
...
('63014', 'นาย', 'ทัยสรรค์  ', 'ดู่ยา', '1559900154103', '2020-02-11', 35, 1, 1, '2020-11-01'),
...
('63019', 'นางสาว', 'อรวีร์  ', 'ทิศรำวัง', '1509901453996', '2020-03-16', 5, 11, 0, '0000-00-00'),
...
('63028', 'นางสาว', 'กรชนก  ', 'อักษรดิษฐ์', '1579900692091', '2020-07-01', 5, 11, 0, '0000-00-00'),
...
('63031', 'นางสาว', 'กันยารัตน์  ', 'บุญมา', '1849900282532', '2020-07-01', 6, 11, 0, '0000-00-00'),
('63032', 'นางสาว', 'บุษยารัตน์  ', 'ป้องภัย', '1549900189535', '2020-07-01', 6, 11, 0, '0000-00-00'),
...
('63035', 'นางสาว', 'ปารียา', 'สมศักดิ์', '1600100551605', '2020-09-01', 11, 11, 0, '0000-00-00'),
('63036', 'นางสาว', 'ขนิสดา', 'วงศ์ศรีหทัย', '1119900461646', '2020-09-08', 35, 5, 0, '0000-00-00'),
('63037', 'นางสาว', 'ปาณิสรา', 'ปัญญาสิทธิ์', '1510100182309', '2020-10-01', 5, 1, 0, '0000-00-00'),
('63038', 'นางสาว', 'วัชราภรณ์', 'ชัยเลิศ', '1509901644911', '2020-10-01', 11, 3, 0, '0000-00-00'),
('63039', 'นางสาว', 'ธิดารัตน์', 'วรรณเลิศ', '1529900590353', '2020-11-01', 11, 3, 0, '0000-00-00'),
('64001', 'นางสาว', 'พีรญา', 'สานเมนทา', '1509970026783', '2020-11-16', 5, 3, 0, '0000-00-00'),
('64002', 'นางสาว', 'ปาจรีย์', 'ผลภาษี', '1509901221742', '2020-11-01', 5, 3, 0, '0000-00-00'),
('64003', 'นางสาว', 'ปภัสสร', 'เลาสูงเนิน', '1579900612764', '2020-11-01', 5, 3, 0, '0000-00-00'),
('64004', 'นางสาว', 'ปทุมวรรณ', 'เมืองมูล', '1560500083791', '2020-11-01', 6, 3, 0, '0000-00-00'),
('64005', 'นาย', 'เปรม', 'นะเจ๊ะ', '1501600011245', '2020-11-16', 6, 3, 0, '0000-00-00'),
('64006', 'นางสาว', 'ธัญชนก', 'มูลยศ', '1505200042821', '2020-11-16', 5, 3, 0, '0000-00-00'),
('64007', 'นาย', 'ธีรวิทย์', 'ตางาม', '1505200020739', '2020-11-16', 5, 3, 0, '0000-00-00');
...
--
-- Indexes for table `sdc_booking`
--
ALTER TABLE `sdc_booking`
  ADD PRIMARY KEY (`booking_id`);

--
-- Indexes for table `sdc_patient`
--
ALTER TABLE `sdc_patient`
...
--
-- AUTO_INCREMENT for table `sdc_booking`
--
ALTER TABLE `sdc_booking`
  MODIFY `booking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `sdc_patient`
--
ALTER TABLE `sdc_patient`
