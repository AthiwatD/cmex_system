            ...
            <tbody>
                <?php 
                    foreach($questions as $question){
                        ...
                        echo "<a href='" . base_url() . "Question/deleteQuestionDo/" . $question->question_id . "' class='btn btn-danger btn-sm' onclick='return confirm(\"คุณต้องการ ลบ?\")'><i class='fas fa-trash'></i>Delete</a> </td>";
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
