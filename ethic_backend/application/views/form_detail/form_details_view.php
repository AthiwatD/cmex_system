            ...
            <tbody>
                <?php 
                    foreach($form_details as $form_detail){
                        ...
                        echo "<a href='" . base_url() . "FormDetail/deleteFormDetailDo/" . $form_detail->form_detail_id . "' class='btn btn-danger btn-sm' onclick='return confirm(\"คุณต้องการ ลบ?\")'><i class='fas fa-trash'></i>Delete</a> </td>";
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
