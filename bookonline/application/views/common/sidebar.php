...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php $bko_url=base_url()."Bookonline/index/".$sys; ?>
    ...
    <a href="<?php echo $bko_url; ?>" class="brand-link">
      <img src="<?php echo base_url(); ?>../common/assets/images/logo_cmex.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 16px;">ระบบหนังสือเวียนออนไลน์</span>
    </a>
