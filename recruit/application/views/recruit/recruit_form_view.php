          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
				            ...
				            <div class="col-sm-9">
				                <select id="ward_code" name="ward_code" class="form-control " style="max-width:100%;" required>
				                    ...
				                    foreach ($query ->result() as $row) {
				                    	if($method == "update"){ ?>
				                    		<option value='<?=$row->ward_code?>' <?php if($row->ward_code==$recruitHd->ward_code) echo "selected"; ?>><?=$row->ward_name1?></option>";<?php
				            ...
				            <div class="col-sm-9">
				                <select id="position_id" name="position_id" class="form-control " style="max-width:100%;" required>
				                    ...
				                    foreach ($query->result_array() as $row) {
				                    	if($method == "update"){ ?>
				                    		<option value="<?=$row['position_id']?>" <?php if($recruitHd->position_id==$row['position_id']) echo "selected"; ?>><?=$row['position_name']?></option> <?php
				            ...
				            <div class="col-sm-9">
				                <select id="position_type_id" name="position_type_id" class="form-control " style="max-width:100%;" required>
				                    ...
				                    foreach($query_pt->result_array() as $row){
				                    	if($method=="update"){ ?>
				                    		<option value="<?=$row['position_type_id']?>" <?php if($recruitHd->position_type_id==$row['position_type_id']) echo "selected";?> ><?=$row['position_type_name']?></option> <?php
				                    	}else if($method=="add"){ ?>
				                    		<option value="<?=$row['position_type_id']?>"><?=$row['position_type_name']?></option> <?php
				                   		}
				                	} ?>
				               </select>
				    ...
				    <div class="form-group">
				    	<div class="row">
				    		<label for="start_date" class="col-sm-3 col-form-label">วันที่ประกาศ</label>
	                    			...
	                    			<?php 
	                    				if($method=="update"){ 
	                    					if(!empty($recruitHd->start_date)){
	                    						...
	                    						<input type="date" class="form-control col-6" id="start_date" name="start_date" required value="<?=$exp[0]?>"> <p class="start_dateError"></p>
		                        				<input type="time" class="form-control col-6" id="start_time" name="start_time" required value="<?=$exp[1]?>"> <p class="start_timeError"></p> <?php
	                    					}
	                    				}else if($method=="add"){ ?>
                  	...
                  	<div class="form-group">
                  		<div class="row">
				    		<label for="start_date" class="col-sm-3 col-form-label">วันที่สิ้นสุด</label>
				    		<div class="col-sm-9" style="float:right;">
				    			<div class="row">
				    				<?php
				    					if(!empty($recruitHd->end_date)){
				    						$exp_end=explode(" ",$recruitHd->end_date); ?>
				    						<input type="date" class="form-control col-6" id="end_date" name="end_date" required value="<?=$exp_end[0]?>"> <p class="end_dateError"></p>
		                        			<input type="time" class="form-control col-6" id="end_time" name="end_time" required value="<?=$exp_end[1]?>"> <p class="end_timeError"></p> <?php
				    					}else{ ?>
				    ...
				    <div class="form-group publish_status1">
				        <div class="row mb-3">
				            ...
				            <div class="col-sm-9">
					            ...
					            <input type="date" class="form-control" id="exam1_date" name="exam1_date" <?php if($method=="update"){ if(!empty($recruitHd->exam1_date)) echo "value='$exp_exam1_date[0]'"; } ?> >
				    ...
				    <div class="form-group publish_status1">
				        <div class="row mb-3">
				            ...
				            <div class="col-sm-9">
					            ...
					            <input type="date" class="form-control" id="exam1_publish_date" name="exam1_publish_date" <?php if($method=="update"){ if(!empty($recruitHd->exam1_publish_date)) echo "value='$exp_exam1_publish_date[0]'"; } ?>>
				    ...
				    <div class="form-group publish_status2">
				        <div class="row mb-3">
				            ...
				            <div class="col-sm-9">
				              ...
				              <input type="date" class="form-control" id="exam2_date" name="exam2_date" <?php if($method=="update"){ if(!empty($recruitHd->exam1_date)) echo "value='$exp_exam2_date[0]'"; } ?>>
				    ...
				    <div class="form-group publish_status2">
				        <div class="row mb-3">
				            ...
				            <div class="col-sm-9">
				              ...
				              <input type="date" class="form-control" id="exam2_publish_date" name="exam2_publish_date" <?php if($method=="update"){ if(!empty($recruitHd->exam2_publish_date)) echo "value='$exp_exam2_publish_date[0]'"; } ?>>
				    ...
				    <div class="form-group publish_status3">
				        <div class="row mb-3">
				            ...
				            <div class="col-sm-9">
				              ...
				              <input type="date" class="form-control" id="exam3_date" name="exam3_date" <?php if($method=="update"){ if(!empty($recruitHd->exam3_date)) echo "value='$exp_exam3_date[0]'"; } ?>>
				    ...
				    <div class="form-group publish_status3">
				        <div class="row mb-3">
				            ...
				            <div class="col-sm-9">
				              ...
				              <input type="date" class="form-control" id="exam3_publish_date" name="exam3_publish_date" <?php if($method=="update"){ if(!empty($recruitHd->exam3_publish_date)) echo "value='$exp_exam3_publish_date[0]'"; } ?>>
                                ...
                                <?php
                            		for($i=0;$i<count(array_filter($recruitDt));$i++){ 
                                		...
                                		echo "<td>".$recruitFile[$i]->file_name."</td>";
                                			...
                                			<td><a href="<?php echo $patchfile; ?>" class="btn btn-info btn-sm" target="_blank"><i class="nav-icon fas fa-sticky-note"></i></a><a href="javascript:void(0);" onclick="formedit_delete_publish_dt('<?=$recruitHd->publish_hd_id?>','<?=$recruitDt[$i]->publish_dt_id?>','<?=$session_username?>');" class="btn btn-danger btn-sm"><i class="fas fa-minus"></i></a>
                                			</td> <?php
                                		echo "</tr>";
                            		}
                                ?>
