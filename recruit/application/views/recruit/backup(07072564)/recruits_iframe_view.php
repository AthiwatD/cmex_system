        ...
        <table class="table table-bordered table-striped my_table_data" style="width:100% !important;">
            <thead>
                <tr>
                    ...
                    <?php if($system=="frontend"){ ?> <th style="min-width: 105px;">วันที่ประกาศ</th> <?php }?>
                    ...
                    <!--<th style="min-width: 70px;">หน่วยงาน</th> --> <!-- [Athiwat][05/07/2564][add comment] -->
                            ...
                            echo "<tr>";
                                ...
                                if($system=="frontend"){
                                    if($seconds_create_date <=604800){ 
                                        ...
                                        <div>
                                            ...
                                            if($seconds_create_date <=604800){ $path_img=base_url()."assets/img/news.gif"; ?>&nbsp; <img src="<?php echo $path_img; ?>" style="margin:-3px 0px 0px 3px;"width="30px">
                                            <?php } ?>
                                ...
                                echo "<td style='color:green;' >";
									...
									if($recruit->end_date>date("Y-m-d H:i:s")){
										if($seconds_create_date <=604800){ ?><span class="badge badge-pill badge-success" style="">เปิดรับสมัคร</span><?php }
										else{ ?>&nbsp;<span class="badge badge-pill badge-success">เปิดรับสมัคร</span><?php }
