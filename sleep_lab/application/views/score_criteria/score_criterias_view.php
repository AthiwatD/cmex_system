            ...
            <tbody>
                <?php 
                    foreach($scoreCriterias as $scoreCriteria){
                        ...
                        echo "<a href='" . base_url() . "ScoreCriteria/deleteScoreCriteriaDo/" . $scoreCriteria->score_criteria_id . "' class='btn btn-danger btn-sm' onclick='return confirm(\"คุณต้องการ ลบ?\")'><i class='fas fa-trash'></i>Delete</a> </td>";
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
