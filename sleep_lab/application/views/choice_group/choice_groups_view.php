            ...
            <tbody>
                <?php 
                    foreach($choice_groups as $choice_group){
                        ...
                        echo "<a href='" . base_url() . "ChoiceGroup/deleteChoiceGroupDo/" . $choice_group->choice_group_id . "' class='btn btn-danger btn-sm' onclick='return confirm(\"คุณต้องการ ลบ?\")'><i class='fas fa-trash'></i>Delete</a> </td>";
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
