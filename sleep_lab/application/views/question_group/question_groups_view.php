            ...
            <tbody>
                <?php 
                    foreach($question_groups as $question_group){
                        ...
                        echo "<a href='" . base_url() . "QuestionGroup/deleteQuestionGroupDo/" . $question_group->question_group_id . "' class='btn btn-danger btn-sm' onclick='return confirm(\"คุณต้องการ ลบ?\")'><i class='fas fa-trash'></i>Delete</a> </td>";
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
