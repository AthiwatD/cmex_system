...
class Moniter_Controller extends CI_Controller {
	function __construct(){
        parent::__construct();
	}
}

class Node_Controller extends CI_Controller {
    ...
    protected function loadView($body_views){
        $this->load->view('common/node/header', $this->data);
        $this->load->view('common/node/navbar', $this->data);
        $this->load->view('common/node/content_header', $this->data);
        foreach($body_views as $body_view){
            $this->load->view($body_view, $this->data);
        }
        $this->load->view('common/node/footer',$this->data);
		$this->load->view('common/node/script',$this->data);
        $this->load->view('common/node/end',$this->data);
    }
